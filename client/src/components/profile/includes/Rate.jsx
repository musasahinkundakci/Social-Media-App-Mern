...
const Rate = ({rate, targetId, setRate, ...props}) => {
    const [index, setIndex] = useState(null)
    const clickHandler = async (num) => {
        try {
            const res = await axios.post("http://localhost:5000/user/rateUser", {
                targetId,
                rate: num,
                comment: ""
    ...
    useEffect(() => {
            ...
            console.log("hahah", props.user.rate)
        },
        [])
    return (
        <>
            <div className="container-rate mb-3">
                <div className="feedback">
                    <div className="rating">
                        {props.user && props.user.rate ?
                            <><input type="radio" name="rating" id="rating-5"
                                     checked={props.user.rate.length > 0 && props.user.rate[0].ratedBy == props.session.user._id && props.user.rate[0].rate == "5"}
                                     onClick={() => clickHandler("5")}
                            />
                                <label htmlFor="rating-5"></label>
                                <input type="radio" name="rating" id="rating-4"
                                       checked={props.user.rate.length > 0 && props.user.rate[0].ratedBy == props.session.user._id && props.user.rate[0].rate == "4"}
                                       onClick={() => clickHandler("4")}/>
                                <label htmlFor="rating-4"></label>
                                <input type="radio" name="rating" id="rating-3"
                                       checked={props.user.rate.length > 0 && props.user.rate[0].ratedBy == props.session.user._id && props.user.rate[0].rate == "3"}
                                       onClick={() => clickHandler("3")}/>
                                <label htmlFor="rating-3"></label>
                                <input type="radio" name="rating" id="rating-2"
                                       checked={props.user.rate.length > 0 && props.user.rate[0].ratedBy == props.session.user._id && props.user.rate[0].rate == "2"}
                                       onClick={() => clickHandler("2")}/>
                                <label htmlFor="rating-2"></label>
                                <input type="radio" name="rating" id="rating-1"
                                       checked={props.user.rate.length > 0 && props.user.rate[0].ratedBy == props.session.user._id && props.user.rate[0].rate == "1"}
                                       onClick={() => clickHandler("1")}/>
                                <label htmlFor="rating-1"></label></> : ""}
                        <div className="emoji-wrapper">
                            <div className="emoji">
                                <svg className="rating-0" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512">
                                ...
                                <svg className="rating-1" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512">
                                    <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                                    <path
                                ...
                                <svg className="rating-2" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512">
                                    <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                                    <path
                                        d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z"
                                ...
                                <svg className="rating-3" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512">
                                    <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                                    <path
                                ...
                                <svg className="rating-4" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512">
                                    <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                                    <path
                                        d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z"
                                ...
                                <svg className="rating-5" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 512 512">
                                    <g fill="#ffd93b">
